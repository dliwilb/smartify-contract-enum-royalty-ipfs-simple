 ...
 */
abstract contract NFTokenMetadataEnumerable is
  ERC721,
  ERC721Metadata,
  ERC721Enumerable,
  ERC2981,
  SupportsInterface
{
  ...
  constructor()
  {
    ...
    supportedInterfaces[0x2a55205a] = true; // liwi: EIP2981 Royalties
  }
  ...
  {
      royalty memory royalty_ = royalties[_tokenId];
      receiver_ = royalty_.receiver;
      royaltyAmount_ = (_salePrice * royalty_.royaltyAmount) / 10000;
  }
  ...
  function _setTokenRoyalty(
      ...
      require(_royaltyAmount <= 10000, 'ERC2981Royalties: Too high');
      royalties[_tokenId] = royalty(_receiver, uint16(_royaltyAmount));
  }
  /** liwi: add EIP2981 */
