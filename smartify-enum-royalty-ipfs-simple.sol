...
contract Smartify is ipfsSimpleNFT {
    ...
    function createToken(uint16 _editions, address _to, bytes32 _part_1, bytes32 _part_2, uint16 _royaltyAmount) public payable mintActive verifyMinter(msg.sender) {
